REBOL [
	title:  "Rebol/Bzip2 module builder"
	type:    module
	date:    12-Jan-2026
	home:    https://github.com/Oldes/Rebol-Bzip2
	version: 1.1.0
	author: @Oldes
]
...
reb-code: ajoin [
	...
	{ Date: } now/utc
	{ License: MIT}
	{ Url: https://github.com/Oldes/Rebol-Bzip2} ;- Use real URL!
	#"]"
]
...
foreach [name spec] commands [
	...
	append enu-commands ajoin ["^/^-CMD_BZIP2_" uppercase copy name #","]
...
#define BZIP2_EXT_INIT_CODE $init-code
...
write %bzip2-rebol-extension.h reword :header self
write %bzip2-commands-table.c  reword :ctable self
